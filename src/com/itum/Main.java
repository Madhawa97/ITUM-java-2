...
public class Main
{
    ...
    public static void main (String[]args)
    {
        ...
        do
        {
            ...
            // Switch player
            currentPlayer = (currentPlayer == CROSS) ? NOUGHT : CROSS;    //inline conditioning statement
    ...
    public static void playerMove (int theSeed)
    {
        ...
        do
        {
            ...
            if (row >= 0 && row < ROWS && col >= 0 && col < COLS
                    && board[row][col] == EMPTY)                    //more validation
            {
    ...
    public static boolean hasWon (int theSeed, int currentRow, int currentCol)
    {
        ...
        return (board[currentRow][0] == theSeed	// 3-in-the-row
                && board[currentRow][1] == theSeed && board[currentRow][2] == theSeed || board[0][currentCol] == theSeed	// 3-in-the-column
                && board[1][currentCol] == theSeed && board[2][currentCol] == theSeed || currentRow == currentCol	// 3-in-the-diagonal
                && board[0][0] == theSeed && board[1][1] == theSeed && board[2][2] == theSeed || currentRow + currentCol == 2	// 3-in-the-opposite-diagonal
                && board[0][2] == theSeed
                && board[1][1] == theSeed && board[2][0] == theSeed);
